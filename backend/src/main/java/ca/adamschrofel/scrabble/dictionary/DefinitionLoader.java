...
public final class DefinitionLoader {
    ...
    /**
     * Loads word definitions from dictionary file on the classpath within
     * /resources.
     * Processing:
     ...
     * @return A HashMap mapping word strings to their definitions
     *         (case-insensitive)
     * @throws RuntimeException If the definition file cannot be found on the
     *                          classpath
     */
    public static Map<String, String> loadDefinitions(String path) {
        ...
        try (Scanner sc = new Scanner(in)) {
            ...
            while (sc.hasNextLine()) {
                ...
                // Extract the word (before the tab) and convert to uppercase for
